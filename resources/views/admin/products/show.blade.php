            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="md:col-span-2 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-mono font-semibold text-lg">{{ $product->serial_number }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="font-semibold">{{ $product->project->name }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <a href="{{ route('standard-packings.show', $product->standardPacking) }}" class="font-mono font-semibold text-blue-600 hover:text-blue-700">
                ...
                <div class="flex justify-center items-center">
                    <div class="text-center">
                        <div class="bg-white p-6 rounded-lg inline-block border-2 border-gray-200">
                            {!! QrCode::size(250)->generate($product->serial_number) !!}
                        </div>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 font-mono">{{ $product->serial_number }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex items-start gap-3 p-3 bg-emerald-50 dark:bg-emerald-900/10 rounded-lg">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500">
                            @if($log->event_type !== 'warranty_activation' && $log->user)
                                {{ $log->user->name }} • 
                            @endif
