...
<head>
    ...
    <title>Login Retail - Aktivasi Garansi</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gradient-to-br from-emerald-50 to-green-50 min-h-screen flex items-center justify-center">
        ...
        <div class="max-w-md mx-auto">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Masukkan PIN retail Anda untuk aktivasi garansi</p>
                </div>
                ...
                <form method="POST" action="{{ route('warranty.activation.verify') }}">
                    ...
                    <button type="submit" class="w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-lg font-semibold hover:from-emerald-600 hover:to-green-700 transition transform hover:scale-105">
                        Masuk
                    </button>
                </form>

                <div class="text-center mt-6">
                    <a href="{{ route('warranty.menu') }}" class="text-gray-600 hover:text-emerald-600 transition">
                        ← Kembali
                    </a>
                </div>
            </div>
